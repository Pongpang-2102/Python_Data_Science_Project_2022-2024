-- This Project , we will show how to create database for Restaurant & data analysis using SQLite
-- Combined for 5 files
...
-- 1 ) find the current employee to update email
-- to firstname.first 2 charactor as upper case(lastname)@th.tastemcu.com 
-- and name that column that"New Email_2022"
